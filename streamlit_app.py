...
if 'view_mode' not in st.session_state:
    st.session_state.view_mode = 'setup' # 'setup' or 'raffle'
...
def render_setup():
    # --- Sidebar Configuration (Only in Setup) ---
    with st.sidebar:
    ...
    with tab1:
        ...
        with col1:
            ...
            # Switch view mode instead of running inline
...
def render_raffle():
    # Only for the raffle page, specialized focused CSS
    st.markdown("""
    <style>
        .stApp {
